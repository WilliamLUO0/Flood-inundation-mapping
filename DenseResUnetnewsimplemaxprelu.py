...
class ResDenseBlocksimpler(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(ResDenseBlocksimpler,self).__init__()
...
class DenseResUnetsimple(nn.Module):
    def __init__(self, in_channels, growth_rate):
        super(DenseResUnetsimple,self).__init__()
        self.BN1 = nn.BatchNorm2d(in_channels)
        ...
        self.dense1 = ResDenseBlocksimpler(in_channels=growth_rate, out_channels= growth_rate*2)
        self.dense2 = ResDenseBlocksimpler(in_channels=growth_rate*2, out_channels=growth_rate*4)
        self.dense3 = ResDenseBlocksimpler(in_channels=growth_rate*4, out_channels= growth_rate*8)
        self.dense4 = ResDenseBlocksimpler(in_channels=growth_rate*8, out_channels= growth_rate*16)
    
        self.upsample1 = UpsampleLayer(in_channels=growth_rate*16, out_channels=growth_rate*8)
        self.dense5 = ResDenseBlocksimpler(in_channels=growth_rate*8*2, out_channels=growth_rate*8)
    
        self.upsample2 = UpsampleLayer(in_channels=growth_rate*8, out_channels=growth_rate*4)
        self.dense6 = ResDenseBlocksimpler(in_channels=growth_rate*4*2, out_channels=growth_rate*4)
        
        self.upsample3 = UpsampleLayer(in_channels=growth_rate*4, out_channels=growth_rate*2)
        self.dense7 = ResDenseBlocksimpler(in_channels=growth_rate*2*2, out_channels=growth_rate*2)
...
if __name__ == '__main__':
    model1 = DenseResUnetsimple(in_channels=5, growth_rate=32)
